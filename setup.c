...
/*   Updated: 2022/12/23 22:12:48 by mmariani         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_setupwindow(t_game *newgame,t_window *windows)
{
	...
	windows->reference = mlx_new_window(newgame->mlx, windows->size.x, windows->size.y, windows->name);
...
void	ft_setupthings(t_game *newgame)
{
	...
	newgame->win.size.x = 45;
	newgame->win.size.y = 45;
